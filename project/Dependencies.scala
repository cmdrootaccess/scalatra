...
object Dependencies {
  ...
  lazy val collectionCompact = "org.scala-lang.modules" %% "scala-collection-compat" % "2.10.0"
  ...
  lazy val metricsServlets = "io.dropwizard.metrics" % "metrics-jakarta-servlets" % "4.2.18"
  lazy val metricsServlet = "io.dropwizard.metrics" % "metrics-jakarta-servlet" % "4.2.18"
  lazy val googleGuava = "com.google.guava" % "guava" % "31.1-jre"
  lazy val twirlApi = "com.typesafe.play" %% "twirl-api" % "1.6.0-RC2"

  private val jettyVersion = "11.0.14"
